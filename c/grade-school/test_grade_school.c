...
static void
test_student_not_added_to_same_grade_in_roster_more_than_once(void) {
  roster_t expected = {3,
                       {(student_t){2, "Blair"}, (student_t){2, "James"},
                        (student_t){2, "Paul"}}};
  roster_t actual;
...
static void test_students_are_sorted_by_grades_in_roster(void) {
  roster_t expected = {
      3,
      {(student_t){1, "Anna"}, (student_t){2, "Peter"}, (student_t){3, "Jim"}}};
  roster_t actual;
  init_roster(&actual);
...
static void test_students_are_sorted_by_name_in_roster(void) {
  roster_t expected = {
      3,
      {(student_t){2, "Alex"}, (student_t){2, "Peter"}, (student_t){2, "Zoe"}}};
  roster_t actual;
  init_roster(&actual);
...
static void
test_students_are_sorted_by_grades_and_then_by_names_in_roster(void) {
  TEST_IGNORE();
  roster_t expected = {7,
...
static void test_student_not_added_to_multiple_grades(void) {
  TEST_IGNORE();
  uint8_t desired_grade = 2;
  roster_t expected = {2, {(student_t){2, "Blair"}, (student_t){2, "James"}}};
  roster_t roster;
  init_roster(&roster);
